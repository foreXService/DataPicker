...
function createSingleDay(date) {
  ...
  if (date.getMonth() != dateNow.getMonth())
    li.classList.add("calendar-another-month");
...
function createCalendar() {
  ...
  const span = (document.querySelector(".calendar #calendar-show").textContent =
    monthNames[dateNow.getMonth()] + " " + dateNow.getFullYear());
}

function createHeader() {
  return (
    '<li class="calendar-weeks">Sun</li>' +
